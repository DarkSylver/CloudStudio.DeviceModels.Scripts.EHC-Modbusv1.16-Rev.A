...
# Parsing + Configuration Script – EHC - Modbus : v1.16 - Rev. A

This **Parsing + Configuration** script is designed for the **EHC - Modbus : v1.16** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – EHC - Modbus : v1.16 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **EHC - Modbus : v1.16** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
